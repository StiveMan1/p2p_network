...
file(GLOB_RECURSE SRC_FILES ${PROJECT_SOURCE_DIR}/lib/nlohmann/*.hpp)
...
file(GLOB_RECURSE INDENT_FILES
        ${PROJECT_SOURCE_DIR}/lib/nlohmann/*.hpp
...
foreach(SRC_FILE ${SRC_FILES})
    ...
    file(RELATIVE_PATH RELATIVE_SRC_FILE "${PROJECT_SOURCE_DIR}/lib/nlohmann" "${SRC_FILE}")
    ...
    target_include_directories(single_${RELATIVE_SRC_FILE} PRIVATE ${PROJECT_SOURCE_DIR}/lib)
